...
val MODEL_SERVER_SCHEMA = buildPermissionSchema {
    ...
    resource("legacy-user-defined-entries") {
        permission("read")
        permission("write")
    }
    ...
    resource("repository") {
        ...
        resource("objects") {
            permission("read") {
                ...
                includes("legacy-global-objects", "read")
            }
            permission("add") {
                includedIn("repository", "write")
                includes("legacy-global-objects", "add")
            ...
            permission("admin") {
                ...
                permission("rewrite") {
                    ...
                    permission("write") {
                        ...
                        includedIn("repository", "write")
                        includes("legacy-user-defined-entries", "write")
                        permission("create") {
                        ...
                        permission("read") {
                            includes("legacy-user-defined-entries", "read")
                            permission("list") {
...
val WORKSPACES_SCHEMA = buildPermissionSchema {
    extends(MODEL_SERVER_SCHEMA)
