...
class AdminPermissionOnServerTest : PermissionTestBase(listOf("model-server/admin")) {

    @Test
    fun `check all granted permissions`() {
        evaluator.instantiatePermission("repository/my-repo/branch/my-branch/read")
