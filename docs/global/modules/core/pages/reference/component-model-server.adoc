...
This can be achieved using the xref:mps/reference/component-cloud-plugin.adoc[modelix MPS plugin]: One can connect an MPS instances to a `model-server`, upload the current module repository, and keep it synchronized.
