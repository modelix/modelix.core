...
class ContentExplorer(private val client: IModelClient, private val repoManager: RepositoriesManager) {
    ...
    fun init(application: Application) {
        application.routing {
            get("/content/") {
                call.respondHtml { contentOverview() }
            }
            get("/content/{versionHash}/") {
                ...
                call.respondHtml { contentPage(rootNode) }
            }
    ...
    private fun HTML.contentOverview() {
        head {
    ...
    private fun HTML.contentPage(rootNode: PNodeAdapter) {
        head {
            title("Content Explorer")
            style {
                +"""
