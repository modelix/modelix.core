    ...
    fun init(application: Application) {
        application.routing {
            ...
            get("/content/repositories/{repository}/branches/{branch}/latest") {
                ...
                call.checkPermission("repository", repository, "branch", branch, "pull")
            ...
            get("/content/repositories/{repository}/versions/{versionHash}") {
                ...
                call.checkPermission("repository", repositoryId.id, "objects", "read")
            ...
            get("/content/repositories/{repository}/versions/{versionHash}/{nodeId}") {
                ...
                call.checkPermission("repository", repositoryId, "objects", "read")
