...
class PermissionsTest {
    ...
    suspend fun ApplicationTestBuilder.createModelClient(grantedPermissions: List<String>, hmac512key: String = jwtSignatureKey, tokenModifier: (JWTCreator.Builder) -> Unit = {}): ModelClientV2 {
        val url = "http://localhost/v2"
