...
public class AddProjectNode_Action extends BaseAction {
  private static final Icon ICON = null;

  public AddProjectNode_Action() {
    super("Add Project", "", ICON);
  ...
  public void doExecute(@NotNull final AnActionEvent event, final Map<String, Object> _params) {
    ...
    String name = Messages.showInputDialog(event.getData(CommonDataKeys.PROJECT), "Name", "Add Project", null);
