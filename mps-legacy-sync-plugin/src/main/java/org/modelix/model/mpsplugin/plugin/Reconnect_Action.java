...
public class Reconnect_Action extends BaseAction {
  private static final Icon ICON = null;

  public Reconnect_Action() {
    super("Reconnect", "", ICON);
  ...
  public boolean isApplicable(AnActionEvent event, final Map<String, Object> _params) {
    if (!(event.getData(MPSCommonDataKeys.TREE_NODE) instanceof ModelServerTreeNode)) {
      return false;
    }
