...
public class ModelServerConnection {
  ...
  public ModelServerConnection(String baseUrl, HttpClient providedHttpClient) {
    ...
    client = new RestWebModelClient(baseUrl, tokenProvider, Arrays.asList(new ConnectionListenerForForbiddenMessage(baseUrl)), providedHttpClient);
