...
public class ModelServerConnections {
  ...
  public ModelServerConnection addModelServer(String url) {
    ...
    ModelServerConnection result = doAddModelServer(url);
    // we do not automatically change the persisted configuration, to avoid cycles
    return result;
  }

  protected ModelServerConnection doAddModelServer(String url) {
    ModelServerConnection newRepo = ListSequence.fromList(modelServers).addElement(new ModelServerConnection(url));
    try {
