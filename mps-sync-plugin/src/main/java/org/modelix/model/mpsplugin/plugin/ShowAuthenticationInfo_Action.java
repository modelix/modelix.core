...
public class ShowAuthenticationInfo_Action extends BaseAction {
  private static final Icon ICON = null;

  public ShowAuthenticationInfo_Action() {
    super("Show Authentication Info", "", ICON);
  ...
  public void doExecute(@NotNull final AnActionEvent event, final Map<String, Object> _params) {
    ...
    String author = modelServer.getAuthor();
    String email = modelServer.getEmail();
    Messages.showInfoMessage(event.getData(CommonDataKeys.PROJECT), "Author: " + author + "\nEmail: " + email, "Authentication Info");
  }
}
