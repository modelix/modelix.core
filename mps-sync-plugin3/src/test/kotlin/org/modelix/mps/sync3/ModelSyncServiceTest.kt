...
class ModelSyncServiceTest {
    ...
    @Test
    fun `switchBranch updates branch reference for matching binding without dropping local changes`() {
        // Given
        ...
        // When
        service.switchBranch(oldBranchRef, newBranchRef, dropLocalChanges = false)
    ...
    @Test
    fun `switchBranch does not affect bindings with different branch references`() {
        // Given
        val service = ModelSyncService(createMockProject())
    ...
    @Test
    fun `switchBranch preserves binding state when updating branch reference`() {
        // Given
        val service = ModelSyncService(createMockProject())
        val repositoryId = RepositoryId("test-repo")
        val oldBranchRef = BranchReference(repositoryId, "old-branch")
    ...
    @Test
    fun `switchBranch throws exception when no matching binding exists`() {
        // Given
        val service = ModelSyncService(createMockProject())
        val repositoryId = RepositoryId("test-repo")
        ...
        val exception = kotlin.test.assertFailsWith<IllegalArgumentException> {
            service.switchBranch(nonExistentBranchRef, newBranchRef, dropLocalChanges = false)
        }
    ...
    @Test
    fun `switchBranch throws exception when no bindings exist at all`() {
        // Given
        val service = ModelSyncService(createMockProject())
        val repositoryId = RepositoryId("test-repo")
        val oldBranchRef = BranchReference(repositoryId, "old-branch")
    ...
    @Test
    fun `switchBranch with dropLocalChanges true clears version hash`() {
        // Given
        val service = ModelSyncService(createMockProject())
        val repositoryId = RepositoryId("test-repo")
        val oldBranchRef = BranchReference(repositoryId, "old-branch")
        ...
        // When
        service.switchBranch(oldBranchRef, newBranchRef, dropLocalChanges = true)
    ...
    @Test
    fun `switchBranch with dropLocalChanges false preserves version hash`() {
        // Given
        val service = ModelSyncService(createMockProject())
        val repositoryId = RepositoryId("test-repo")
        val oldBranchRef = BranchReference(repositoryId, "old-branch")
    ...
    @Test
    fun `switchBranch with dropLocalChanges true only affects matching binding`() {
        // Given
        val service = ModelSyncService(createMockProject())
        val repositoryId1 = RepositoryId("test-repo-1")
        val repositoryId2 = RepositoryId("test-repo-2")
