...
// class MpsReplicatedRepositoryV2(
//    client: IModelClientV2,
//    branchReference: BranchReference,
// ) : ReplicatedModel(client, branchReference, null) {
//
//    companion object {
//        private val instances = mutableSetOf<MpsReplicatedRepositoryV2>()
//
//        private val affectedDocuments = mutableSetOf<DocumentReference>()
//
//        private val logger = logger<MpsReplicatedRepositoryV2>()
//
//        fun disposeAll() {
//            val list: List<MpsReplicatedRepositoryV2>
