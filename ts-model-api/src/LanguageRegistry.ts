...
export class LanguageRegistry {
  ...
  private nodeWrappers: Map<string, (node: INodeJS) => TypedNode> | undefined =
    undefined;
  private concepts: Map<string, IConceptJS> | undefined = undefined;
  public wrapperCache: ((node: ITypedNode) => ITypedNode) | undefined =
    undefined;
  ...
  public wrapNode(node: INodeJS): ITypedNode {
    ...
    const wrapped =
      wrapper === undefined ? new UnknownTypedNode(node) : wrapper(node);
